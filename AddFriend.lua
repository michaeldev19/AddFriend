...
local AButtonTxt = {AF_LOCALE["Add_Friend"], AF_LOCALE["Remove_Friend"], AF_LOCALE["Add_Guild"], AF_LOCALE["Remove_Guild"]};
local AToolTips = {AF_LOCALE["Add_Friend_TT"], AF_LOCALE["Remove_Friend_TT"], AF_LOCALE["Add_Guild_TT"], AF_LOCALE["Remove_Guild_TT"]};
